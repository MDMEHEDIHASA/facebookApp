...
export default class RegistrationForm{
    ...
    formSubmitHandler(){
        this.usernameImmadiately();
        this.usernameAfterDelay();
        this.emailAfterDelay();
        this.passwordImmadiately();
        this.passwordAfterDelay();

        if(
                this.data.username.isUnique && 
    ...
    passwordImmadiately(){
        if(this.password.value.length > 50){
            this.showValidationError(this.password,"Password cannot exceeed 50 character.")
        }
    ...
    passwordAfterDelay(){
        if(this.password.value.length < 8){
            this.showValidationError(this.password,"Password must be at least 8 character.")
        }
    }
    ...
    emailAfterDelay(){
        ...
        if(!/^\S+@\S+$/.test(this.email.value)){
           this.showValidationError(this.email,"You must provide a vaild email address.")
         }
