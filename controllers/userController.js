...
exports.login = async function(req,res){
    ...
    user.login().then((result)=>{
        ...
        //req.session.flash.errors = [result]
        req.session.save(function(){
            res.redirect('/');
        })
...
exports.register = function(req,res){
    let user = new User(req.body);
    user.register().then(() => {
        req.session.user = {username: user.data.username, avatar:user.avatar, _id:user.data._id}//req.session.username
        req.session.save(function(){
            res.redirect('/');
        })
    }).catch((regErrors) => {
        regErrors.forEach(function(error){
            req.flash('regErrors', error)//this.errors
...
exports.home = async function(req,res){
    if(req.session.user){
       ...
       res.render('home-deshboard',{posts: posts});
    }else{
